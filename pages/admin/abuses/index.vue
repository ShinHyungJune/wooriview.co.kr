        ...
        <div class="manage-wrap">
            <div class="title-wrap row-group">
                ...
                <div class="btn-wrap col-group">
                    <nuxt-link to="/admin/abuses/create" class="add-btn">신규 추가</nuxt-link>
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tbody>
                    <tr v-for="(item, index) in items.data" :key="item.id" @click="$router.push(`/admin/abuses/create?id=${item.id}`)">
                        <td>
...
export default {
    ...
    methods: {
        filter(){
            ...
            this.$axios.get("/api/admin/abuses", {
                params: this.form
            }).then(response => {
        ...
        remove(){
            this.form.delete("/api/admin/abuses/1")
                .then(response => {
        ...
        up(e, item, index){
            ...
            if(index > 0){
                ...
                this.form.patch("/api/admin/abuses/" + item.id + "/up")
                    .then(response => {
        ...
        down(e, item, index){
            ...
            if(index < this.items.data.length){
                ...
                this.form.patch("/api/admin/abuses/" + item.id + "/down")
                    .then(response => {
