        ...
        <div class="manage-wrap">
            <div class="title-wrap row-group">
                <div class="col-group">
                    <div class="menu-wrap col-group">
                        ...
                        <ul class="tab-link col-group">
                            ...
                            <li :class="`${form.type === '충전' ? 'active' : ''}`" @click="() => { form.page = 1; form.type = '충전'; filter()}" data-tab="tab_2">충전</li>
                            <li :class="`${form.type === '사용' ? 'active' : ''}`" @click="() => { form.page = 1; form.type = '사용'; filter()}" data-tab="tab_3">사용</li>
                        </ul>
                    </div>
                ...
                <div class="btn-wrap col-group">
                    <nuxt-link to="/admin/banners/create" class="add-btn">신규 추가</nuxt-link>
...
export default {
    ...
    methods: {
        ...
        remove(){
            this.form.delete("/api/admin/banners/1")
                .then(response => {
