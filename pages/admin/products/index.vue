        ...
        <div class="manage-wrap">
            <div class="title-wrap row-group">
                ...
                <div class="btn-wrap col-group">
                    <nuxt-link to="/admin/products/create" class="add-btn">신규 추가</nuxt-link>
...
<!--                        <th>첫구매 할인 비율<br/>(단순표시용)</th>-->
                    ...
                    <tbody>
                    <tr v-for="(item, index) in items.data" :key="item.id" @click="$router.push(`/admin/products/create?id=${item.id}`)">
                        <td>
...
export default {
    ...
    methods: {
        ...
        remove(){
            this.form.delete("/api/admin/products/1")
                .then(response => {
