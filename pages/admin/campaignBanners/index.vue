        ...
        <div class="manage-wrap">
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tbody>
                    <tr v-for="(item, index) in items.data" :key="item.id" @click="$router.push(`/admin/campaignBanners/create?id=${item.id}`)">
                        <td>
...
export default {
    ...
    methods: {
        filter(){
            ...
            this.$axios.get("/api/admin/campaignBanners", {
                params: this.form
            }).then(response => {
        ...
        remove(){
            this.form.delete("/api/admin/campaignBanners/1")
                .then(response => {
        ...
        up(e, item, index){
            ...
            if(index > 0){
                ...
                this.form.patch("/api/admin/campaignBanners/" + item.id + "/up")
                    .then(response => {
        ...
        down(e, item, index){
            ...
            if(index < this.items.data.length){
                ...
                this.form.patch("/api/admin/campaignBanners/" + item.id + "/down")
                    .then(response => {
