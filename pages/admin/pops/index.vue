        ...
        <div class="manage-wrap">
            <div class="title-wrap row-group">
                ...
                <div class="btn-wrap col-group">
                    <nuxt-link to="/admin/pops/create" class="add-btn">신규 추가</nuxt-link>
...
export default {
    ...
    methods: {
        ...
        remove(){
            this.form.delete("/api/admin/pops/1")
                .then(response => {
        ...
        up(e, item, index){
            ...
            if(index > 0){
                ...
                this.form.patch("/api/admin/pops/" + item.id + "/up")
                    .then(response => {
        ...
        down(e, item, index){
            ...
            if(index < this.items.data.length){
                ...
                this.form.patch("/api/admin/pops/" + item.id + "/down")
                    .then(response => {
