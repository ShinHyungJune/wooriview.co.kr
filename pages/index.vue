                ...
                <div class="boxes">
                    <div class="box-wrap">
                        <a href="#" class="box" @click.prevent="checkCompany">
                            <div class="img-wrap">
                                <img src="/images/캠페인등록.svg?v=1" alt="">
                            </div>
                    ...
                    <div class="box-wrap">
                        <nuxt-link to="/mypage" class="box">
                            <div class="img-wrap">
                                <img src="/images/나의캠페인.svg?v=1" alt="">
                            </div>
                    ...
                    <div class="box-wrap">
                        <nuxt-link to="/guides" class="box">
                            <div class="img-wrap">
                                <img src="/images/이용가이드.svg?v=1" alt="">
                            </div>
                    ...
                    <div class="box-wrap">
                        <nuxt-link to="/qnas" class="box">
                            <div class="img-wrap">
                                <img src="/images/고객센터.svg?v=1" alt="">
                            </div>
                    ...
                    <div class="box-wrap">
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSejYcDdXucpmhh6fGIlX1r2GSQZr97UZiS8vh294vsAb8TKRQ/viewform" class="box">
                            <div class="img-wrap">
                                <img src="/images/입점문의.svg?v=1" alt="">
                            </div>
