<template>
    <main id="main" class="MyPage inquiry-detail">
        ...
        <div class="section1" v-if="item">
            <div class="container">
                <div class="contents">
                    <p class="title">문의제목</p>
                    <div class="grey-box title-wrap">
                        <p class="content-title">[{{ item.category }}] {{item.title}}</p>
                        <p class="date">{{ item.format_created_at }}</p>
                    </div>
                </div>
                <div class="contents">
                    <p class="title">추가내용</p>
                ...
                <div class="btn-wrap">
                    <a href="#" @click.prevent="() => {$router.back()}">뒤로가기</a>
                </div>
            </div>
        </div>
    </main>
