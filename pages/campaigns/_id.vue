            ...
            <div class="Side_wrap">
                <section class="section2">
                    <div>
                        ...
                        <p class="advertiser-talk" style="white-space: pre-line">{{campaign.type_campaign === 'REVIEW' ? "[구매평 진행방식 유의사항]"
                            + "\n* 본 캠페인의 선정된 리뷰어는 선구매 후 구매평 리뷰를 작성해주셔야 합니다."
                            + "\n* 구매처에서 아래 옵션대로 구매 시 결제금액이 일치하는지 확인 후 구매 부탁드립니다."
                            + "\n* 본 캠페인의 선정된 리뷰어는 선구매 후 구매평 리뷰를 작성해주셔야 합니다."
                            + "\n* 반드시 별도의 쿠폰이나 포인트 적용 없이 구매 진행해주셔야 합니다."
                            : ''
                            }}
            ...
            <section class="section3">
                ...
                <div class="Information-wrap">
                    <div class="Information-box">
                        ...
                        <p class="Information-content" v-text="campaign.product_and_price" style="white-space: pre-line"></p>
                    </div>
        ...
        return {
            ...
            meta: [
                ...
                },
                {
                    ...
                    content: this.campaign ? this.campaign.product_and_price : ''
                },
                {
                    hid: 'og:image',
                    property: 'og:image',
